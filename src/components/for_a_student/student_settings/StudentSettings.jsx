          ...
          <div className="divs">
            ...
            <div className="div2 all">
              ...
              <div className="content">
                ...
                <div className="down">
                  <button onClick={() => setShowSecurityModal(true)}><span>Manage</span><FaLongArrowAltRight className='icon'/></button>
                </div>
              </div>
            </div>
            ...
            <div className="div3 all">
              ...
              <div className="content">
                ...
                <div className="mid">
                  <p>Control how you receive notifications and alerts.</p>
                </div>
                <div className="down">
              ...
              <div className="notification_section">
                ...
                <div className="toggle_item">
                  <div className="toggle_info">
                    ...
                    <p>Receive email reminders for upcoming assignments</p>
                  </div>
                ...
                <div className="toggle_item">
                  <div className="toggle_info">
                    ...
                    <p>Notifications when new resources are available</p>
                  </div>
                  <input type="checkbox" defaultChecked />
                </div>
              </div>
          ...
          <div className="settings_modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="settings_modal_body">
              ...
              <div className="form_group">
                ...
                <input type="email" value="john.doe@student.com" disabled />
              </div>
            ...
            <div className="settings_modal_body">
              ...
              <div className="feedback_benefits">
                ...
                <ul>
                  ...
                  <li>Makes the platform better for all students</li>
                </ul>
              </div>
            </div>
